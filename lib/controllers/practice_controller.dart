...
class PracticeController extends GetxController {
  ...
  final Rxn<LessonUnitModel> currentUnit = Rxn<LessonUnitModel>();
  final Rxn<CharacterModel> currentCharacter = Rxn<CharacterModel>();
  ...
  void startLesson(LessonUnitModel unit, CharacterModel character) {
  ...
  List<String> _generatePinyinOptions(CharacterModel character) {
  ...
  List<String> _generateMeaningOptions(CharacterModel character) {
    final characters = progressController.characters;
